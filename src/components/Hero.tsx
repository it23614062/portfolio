...
export default function Hero() {
  ...
  return (
    <section id="hero" className="section relative isolate flex min-h-screen flex-col justify-center overflow-visible">
      <div aria-hidden="true" className="pointer-events-none absolute -inset-16 -z-10 overflow-visible sm:-inset-20">
        <div className="absolute top-[10%] right-[-5%] w-96 h-96 rounded-full bg-accent/10 blur-3xl animate-float" />
        <div
          className="absolute bottom-[10%] left-[-5%] w-96 h-96 rounded-full bg-accent/10 blur-3xl animate-float"
